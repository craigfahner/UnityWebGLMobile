...
public struct SpawnableCadillac
{
    public GameObject prefab; // The prefab to spawn
    public int samplePoint; // The sample point to spawn at
}

public class SpawnCadillacs : MonoBehaviour
{
    ...
    public List<SpawnableCadillac> spawnableCadillacs;
    ...
    void Start()
    {
        ...
        Debug.Log("Sample points: " + string.Join(", ", spawnableCadillacs.Select(item => item.samplePoint.ToString()).ToArray()));
    ...
    void Update()
    {
        ...
        foreach (var item in spawnableCadillacs)
        {
