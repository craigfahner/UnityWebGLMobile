...
public struct SpawnableItemsss
{
    public GameObject prefab; // The prefab to spawn
    public int samplePoint; // The sample point to spawn at
}

public class SpawnRusty : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentSample > 5270000) // Replace `certainNumber` with your specific audio sample threshold
        {
            Origin.SetActive(false);
        }

        if (currentSample > 4650892 & currentSample < 5270000) // Replace `certainNumber` with your specific audio sample threshold
        {
